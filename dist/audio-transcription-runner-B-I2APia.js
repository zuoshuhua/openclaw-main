import { h as resolveAgentModelPrimaryValue, m as resolveAgentModelFallbackValues } from "./agent-scope-C20LDXxH.js";
import { p as shouldLogVerbose, t as createSubsystemLogger, u as logVerbose, w as resolvePreferredOpenClawTmpDir } from "./subsystem-Cz-8RV-1.js";
import { _ as runExec } from "./workspace-BPZaOnoC.js";
import { Ln as resolveOpenClawAgentDir, M as resolveApiKeyForProvider, Y as loadConfig, at as isInboundPathAllowed, c as normalizeProviderId, g as normalizeGoogleModelId, it as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, j as requireApiKey, ot as mergeInboundPathRoots, st as resolveIMessageAttachmentRoots } from "./model-selection-B7s8ALQI.js";
import { t as normalizeChatType } from "./chat-type-DKb2TlGZ.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-CuX2qoDO.js";
import { T as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-CqminYp6.js";
import { a as getDefaultMediaLocalRoots, n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-CDsIFpm_.js";
import { n as fetchWithTimeout } from "./fetch-timeout-CYFFedEH.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BVtuO-MG.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-Bkv5oL5u.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-BddkV1I3.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-C0JlS5iU.js").then((n) => n.r);
