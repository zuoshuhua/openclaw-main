...
import { n as isLocalishHost, o as isTrustedProxyAddress, r as isLoopbackAddress, u as resolveClientIp } from "./ws-C4l4080-.js";
...
async function authorizeGatewayConnect(params) {
	...
	if (auth.mode === "token") {
		...
		const { verifyDynamicUserToken } = await import("./auth-dynamic-token-BqJ0Ni43.js");
