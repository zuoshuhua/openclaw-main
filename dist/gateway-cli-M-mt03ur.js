...
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-6U2lAbL1.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-BLnvB3eQ.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-Ct5JxpLL.js";
...
import { a as getMachineDisplayName, i as startBrowserControlServiceFromConfig, n as createBrowserRouteDispatcher, r as createBrowserControlContext } from "./with-timeout-g9Hc8gJp.js";
import { j as runGlobalGatewayStopSafely, k as getGlobalHookRunner, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-2L_GVurB.js";
...
import { C as resolveToolProfilePolicy, _ as collectExplicitAllowlist, y as mergeAlsoAllowPolicy } from "./sandbox-BciY2ZnY.js";
...
import { a as resolveGatewayAuth, c as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, i as isLocalDirectRequest, l as createAuthRateLimiter, n as authorizeHttpGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, r as authorizeWsControlUiGatewayConnect, s as AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH, t as assertGatewayAuthConfigured, u as normalizeRateLimitClientIp } from "./auth-BeAXhE_9.js";
import { l as ensureGatewayStartupAuth, u as mergeGatewayTailscaleConfig } from "./server-context-Ddpp6xy3.js";
...
import { g as registerUnhandledRejectionHandler } from "./audio-transcription-runner-BBm1GGMT.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-Cy8a6YyI.js";
import { x as extractTextFromChatContent } from "./image-BxDNLoeI.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-ig5Eoa1Q.js";
...
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-s190BE30.js";
...
import { a as pruneAgentConfig, i as loadAgentIdentity, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-5OghDq1w.js";
...
import { n as addGatewayServiceCommands } from "./daemon-cli-bNk-Nbwa.js";
...
import { a as probeGateway, n as collectEnabledInsecureOrDangerousFlags } from "./audit-6VfhKFLo.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-BArDqMtv.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-CmC1MjtJ.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines, u as isCronSystemEvent } from "./health-C-2L8fLV.js";
...
import { t as installSkill } from "./skills-install-Cch9Wzo2.js";
import { t as runGatewayUpdate } from "./update-runner-BXPr5AQ3.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-CvZuo_OH.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./server-BcgPaRq0.js");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		...
		const { deliverOutboundPayloads } = await import("./deliver-2L_GVurB.js").then((n) => n.n);
