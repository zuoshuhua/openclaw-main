import { Mn as requireApiKey, Nn as resolveApiKeyForProvider, S as resolveIMessageAttachmentRoots, _n as normalizeGoogleModelId, b as isInboundPathAllowed, n as loadConfig, or as resolveOpenClawAgentDir, un as normalizeProviderId, x as mergeInboundPathRoots, y as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS } from "./config-BmhsqdYr.js";
import { T as resolvePreferredOpenClawTmpDir, p as shouldLogVerbose, t as createSubsystemLogger, u as logVerbose } from "./subsystem-D6oMbtUD.js";
import { D as runExec, H as resolveAgentModelFallbackValues, U as resolveAgentModelPrimaryValue } from "./agent-scope-9Jx8TNbO.js";
import { t as normalizeChatType } from "./chat-type-C4pAlbsI.js";
import { n as fetchWithTimeout } from "./fetch-timeout-C-qHqfzG.js";
import { c as detectMime, f as isAudioFileName, m as kindFromMime, u as getFileExtension } from "./image-ops-D__KhkKk.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-DLYDvtEU.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-DjU9gGw0.js";
import { t as describeImageWithModel, w as ensureOpenClawModelsJson } from "./image-BFV6ZAPg.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BKvUhY2a.js";
import { n as resolveProxyFetchFromEnv } from "./proxy-fetch-BvsXW6tN.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-B-X7Bj1y.js").then((n) => n.r);
