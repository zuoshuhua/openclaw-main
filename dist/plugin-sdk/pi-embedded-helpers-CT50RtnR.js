...
import { Gn as resolveSecretRefValues, Qn as secretRefKey, V as getBlockedNetworkModeReason, n as loadConfig, o as writeConfigFile, t as createConfigIO } from "./config-BmhsqdYr.js";
import { i as defaultRuntime, t as createSubsystemLogger } from "./subsystem-D6oMbtUD.js";
import { S as truncateUtf16Safe, h as resolveUserPath } from "./utils-Dvmyx0m4.js";
import { f as parseBooleanValue, t as formatCliCommand, u as resolveSecretInputRef } from "./command-format-CJB6Ncs3.js";
import { A as openBoundaryFile, D as runExec, F as resolvePathViaExistingAncestorSync, _ as DEFAULT_IDENTITY_FILENAME, b as DEFAULT_USER_FILENAME, d as resolveSessionAgentId, g as DEFAULT_HEARTBEAT_FILENAME, h as DEFAULT_BOOTSTRAP_FILENAME, m as DEFAULT_AGENT_WORKSPACE_DIR, p as DEFAULT_AGENTS_FILENAME, r as resolveAgentConfig, v as DEFAULT_SOUL_FILENAME, x as ensureAgentWorkspace, y as DEFAULT_TOOLS_FILENAME } from "./agent-scope-9Jx8TNbO.js";
import { t as CHANNEL_IDS } from "./registry-BVz0kWJu.js";
import { A as acquireSessionWriteLock, H as canonicalizeMainSessionAlias, U as resolveAgentMainSessionKey } from "./sessions-Dj-UlljP.js";
import { r as writeJsonAtomic } from "./json-files-BLPb80aT.js";
import { n as extractErrorCode, r as formatErrorMessage } from "./errors-aZpciL43.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-BjeQ193W.js";
import { i as getImageMetadata, n as buildImageResizeSideGrid, s as resizeToJpeg, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-D__KhkKk.js";
import { t as SsrFBlockedError } from "./ssrf-Vn2lDwyW.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-CV8lcMiQ.js";
import { i as resolveWindowsSpawnProgram, n as materializeWindowsSpawnProgram } from "./windows-spawn-Az3x4YRP.js";
import { a as syncSkillsToWorkspace, h as safeEqualSecret, l as resolveSandboxInputPath, m as sanitizeEnvVars, u as resolveSandboxPath } from "./skills-D2oHAPJ2.js";
import { A as DEFAULT_DOWNLOAD_DIR, B as DEFAULT_AI_SNAPSHOT_MAX_CHARS, C as ensureChromeExtensionRelayServer, D as PROFILE_POST_RESTART_WS_TIMEOUT_MS, E as PROFILE_ATTACH_RETRY_TIMEOUT_MS, F as resolveWritablePathWithinRoot, G as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, H as DEFAULT_BROWSER_EVALUATE_ENABLED, K as isLoopbackHost, L as normalizeBrowserFormField, M as DEFAULT_UPLOAD_DIR, N as resolveExistingPathsWithinRoot, O as resolveCdpReachabilityTimeouts, R as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, T as CDP_JSON_NEW_TIMEOUT_MS, U as DEFAULT_OPENCLAW_BROWSER_COLOR, V as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, W as DEFAULT_OPENCLAW_BROWSER_ENABLED, _ as withBrowserNavigationPolicy, a as resolveOpenClawUserDataDir, b as fetchOk, c as resolveBrowserExecutableForPlatform, f as normalizeCdpWsUrl, g as assertBrowserNavigationResultAllowed, h as assertBrowserNavigationAllowed, i as launchOpenClawChrome, j as DEFAULT_TRACE_DIR, l as captureScreenshot, m as InvalidBrowserNavigationUrlError, n as isChromeCdpReady, o as stopOpenClawChrome, p as snapshotAria, r as isChromeReachable, u as createTargetViaCdp, v as appendCdpPath, w as stopChromeExtensionRelayServer, y as fetchJson, z as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS } from "./chrome-D3SFhRAQ.js";
import { a as saveMediaBuffer, n as ensureMediaDir } from "./store-CueAm6QV.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-gCi6rjT7.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-gCi6rjT7.js")).closePlaywrightBrowserConnection();
	} catch {}
}
