import { p as normalizeSkillFilter } from "./agent-scope-C20LDXxH.js";
import { t as createSubsystemLogger, w as resolvePreferredOpenClawTmpDir } from "./subsystem-Cz-8RV-1.js";
import { h as resolveUserPath, t as CONFIG_DIR } from "./utils-Dkpkr730.js";
import { O as isPathInside, h as resolveOpenClawPackageRootSync } from "./workspace-BPZaOnoC.js";
import { An as isDangerousHostEnvVarName, Cn as isPathInsideWithRealpath, Lt as normalizePluginsConfig, Mt as loadPluginManifestRegistry, Rt as resolveEffectiveEnableState, zt as resolveMemorySlotDecision } from "./model-selection-B7s8ALQI.js";
import { s as normalizeResolvedSecretInputString } from "./env-CzhFkGTc.js";
import { a as resolveOpenClawManifestBlock, c as resolveOpenClawManifestRequires, d as hasBinary, f as isConfigPathTruthyWithDefaults, i as parseOpenClawManifestInstallBase, l as parseFrontmatterBlock, n as normalizeStringList, o as resolveOpenClawManifestInstall, r as parseFrontmatterBool, s as resolveOpenClawManifestOs, t as getFrontmatterString, u as evaluateRuntimeEligibility } from "./frontmatter-CRguOQQT.js";
import { n as assertNoPathAliasEscape } from "./path-alias-guards-hzH0WXBo.js";
...
function loadSkillEntries(workspaceDir, opts) {
	...
	return Array.from(merged.values()).map((skill) => {
		...
		try {
			...
			const stats = fsSync.statSync(skill.filePath);
