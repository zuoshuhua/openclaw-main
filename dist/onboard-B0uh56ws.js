...
import { a as ensureWorkspaceAndSessions, b as waitForGatewayReachable, c as handleReset, g as resolveControlUiLinks, h as randomToken, n as applyWizardMetadata, t as DEFAULT_WORKSPACE, u as normalizeGatewayTokenInput } from "./onboard-helpers-DTas8nwf.js";
...
async function runNonInteractiveOnboardingLocal(params) {
	...
	if (!opts.skipHealth) {
		const { healthCommand } = await import("./health-CZW_vCBj.js").then((n) => n.i);
