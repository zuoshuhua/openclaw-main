...
import { Ht as describeFailoverError, Ut as maskApiKey, a as DEFAULT_OAUTH_WARN_MS, gt as loadProviderUsageSummary, o as buildAuthHealthSummary, p as runEmbeddedPiAgent, s as formatRemainingShort, vt as formatUsageWindowSummary, yt as resolveUsageProviderId } from "./reply-LI5QTEAc.js";
...
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-BgHjFCzU.js";
...
import { r as resolveForwardCompatModel } from "./model-BAaY3_Wg.js";
...
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-DMMAsW1D.js";
import "./session-cost-usage-JyYmHRDe.js";
import { f as openUrl } from "./onboard-helpers-DKmsxZnQ.js";
...
import { a as isLocalBaseUrl, c as normalizeAlias, d as resolveModelTarget, f as updateConfig, i as formatTokenK, l as resolveKnownAgentId, n as ensureFlagCompatibility, o as loadValidConfigOrThrow, r as formatMs, s as mergePrimaryFallbackConfig, t as applyDefaultModelPrimaryUpdate, u as resolveModelKeysFromEntries } from "./shared-DWTHAwyM.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-B1NywU6p.js";
import { n as logConfigUpdated } from "./logging-uAKXu_UT.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-CeKREI-b.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./model-selection-DIQNSl-z.js").then((n) => n.ht);
	const cfg = await loadModelsConfig({
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-BAaY3_Wg.js").then((n) => n.t);
