import { Br as resolveImplicitCopilotProvider, F as loadConfig, Rr as normalizeProviders, Vr as resolveImplicitProviders, rr as resolveOpenClawAgentDir, zr as resolveImplicitBedrockProvider } from "./auth-profiles-dV37hbSg.js";
...
async function readRawFile(pathname) {
	try {
		return await fsPromises.readFile(pathname, "utf8");
	} catch {
		return "";
	}
}
