...
import { F as loadConfig, lt as parseDurationMs, yn as splitShellArgs } from "./auth-profiles-dV37hbSg.js";
...
import { r as getMemoryCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-DVM9nwGB.js";
import { f as listMemoryFiles, p as normalizeExtraMemoryPaths } from "./query-expansion-D_ncaOVg.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-DqVZAlhj.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-CSSpUr0f.js").then((n) => n.t);
