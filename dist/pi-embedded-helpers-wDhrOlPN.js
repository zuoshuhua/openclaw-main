...
import { B as canonicalizeMainSessionAlias, K as acquireSessionWriteLock, V as resolveAgentMainSessionKey } from "./sessions-CJrpgXR9.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-Bdk3k0dB.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DXJ7zgnU.js");
	} catch (err) {
...
async function closePlaywrightBrowserConnection() {
	try {
		await (await import("./pw-ai-DXJ7zgnU.js")).closePlaywrightBrowserConnection();
	} catch {}
}
