import { o as resolveConfigPath } from "./paths-BMo6kTge.js";
...
function consumeKnownOptionToken(args, index, booleanFlags, valueFlags) {
	const arg = args[index];
	if (!arg || arg === FLAG_TERMINATOR || !arg.startsWith("-")) return 0;
...
//#endregion
export { buildParseArgv as A, isRootHelpInvocation as B, loggingState as C, tryParseLogLevel as D, normalizeLogLevel as E, getPrimaryCommand as F, isValueToken as G, shouldMigrateStateFromPath as H, getVerboseFlag as I, isBunRuntime as K, hasFlag as L, getCommandPositionalsWithRootOptions as M, getFlagValue as N, readLoggingConfig as O, getPositiveIntFlagValue as P, hasHelpOrVersion as R, resolveEnvLogLevelOverride as S, levelToMinLevel as T, FLAG_TERMINATOR as U, isRootVersionInvocation as V, consumeRootOptionToken as W, isFileLogLevelEnabled as _, logVerbose as a, isValidTimeZone as b, shouldLogVerbose as c, colorize as d, isRich as f, getResolvedLoggerSettings as g, getLogger as h, isYes as i, getCommandPathWithRootOptions as j, resolvePreferredOpenClawTmpDir as k, success as l, getChildLogger as m, info as n, logVerboseConsole as o, theme as p, isNodeRuntime as q, isVerbose as r, setVerbose as s, danger as t, warn as u, toPinoLikeLogger as v, ALLOWED_LOG_LEVELS as w, resolveNodeRequireFromMeta as x, formatLocalIsoWithOffset as y, hasRootVersionAlias as z };